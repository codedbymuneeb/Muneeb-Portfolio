...
export default function Hero() {
    const introText = "Building Real-Time Traffic Analytics & Intelligent Vision Systems.".split(" ");

    return (
        <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
            {/* Background Marquee */}
            <div className="absolute inset-0 z-0 flex flex-col justify-center opacity-5 pointer-events-none mt-20">
                <ScrollVelocityText baseVelocity={-2}>AI ENGINEER</ScrollVelocityText>
                <ScrollVelocityText baseVelocity={2}>COMPUTER VISION SPECIALIST</ScrollVelocityText>
            </div>
